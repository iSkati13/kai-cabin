...
// Add this function to booking.js (copied from subscribe.js)
function showSubscribeModal(title, message, isSuccess) {
      ...
      try {
        ...
        if (subscribeChecked && subEmail) {
          try {
            ...
            // resetForm() will be called after user closes modal
            return;
          } catch (err) {
            showSubscribeModal(
              "Subscription Error",
        ...
        // If not subscribing, just show the reservation success and reset
